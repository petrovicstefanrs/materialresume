	<section class="preview_section">
		<div class="publicresume_menu">
			<?php 
				echo "<div class='preview_btn_block'>";
					echo "<a alt='DOWNLOAD AS PDF' class='download_btn' href='https://pdfcrowd.com/url_to_pdf/?width=210mm&use_print_media=1&pdf_name=MaterialResume'><i class='fa fa-download' aria-hidden='true'></i></a>";
					/*echo "<a alt='DOWNLOAD AS PDF' class='download_btn' href='https://pdfcrowd.com/url_to_pdf/?width=210mm&height=297mm&use_print_media=1&pdf_name=MaterialResume'><i class='fa fa-download' aria-hidden='true'></i></a>"; */
				echo "</div>";
			?>
			<div class="logo">
